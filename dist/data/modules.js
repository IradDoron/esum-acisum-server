        ...
        chapters: [
            {
                ...
                elements: [
                    {
                        type: 'paragraph',
                        content: 'טכניקת השורשים זאת טכניקת ליווי לפסנתר. למעשה זאת הטכניקה הכי בסיסית שאני יכול לחשוב עליה, ולכן זאת הטכניקה הראשונה שכדאי ללמוד כאשר רוצים להתחיל ללוות בפסנתר.',
                    },
                    {
                        type: 'paragraph',
                        children: [],
                    ...
                    },
                    {
                        type: 'paragraph',
                        children: [],
                        content: 'אצבע מספר 5 זאת הזרת, כמו שאפשר לראות בציור הנהדר הזה שמראה את מספרי האצבעות בהקשר של נגינה בפסנתר:',
                    },
                    {
                        type: 'image',
                        children: [],
                ...
                elements: [
                    {
                        type: 'paragraph',
                        children: [],
                        content: 'אומרים שתמונה שווה אלף מילים, אז תעשו את החשבון כמה סרטון של 43 שניות שווה. אראה לכם איך מלווים בטכניקת השורשים את מהלך האקורדים הבא:',
                    },
                    {
                        type: 'chordilon',
                        content: {
                    ...
                    {
                        type: 'paragraph',
                        content: 'בהרבה דוגמאות אני אדגים טכניקות נגנה על מהלך אקורדים שבנוי מקבוצות של 4 אקורדים שכל אחד נמשך תיבה אחת. לפעמים אנגן את מהלך האקורדים יותר פעם אחת, ולרוב כדי לסיים אותו אנגן בסוף את האקורד הראשון במהלך. למשל כאן האקורד האחרון שכתבתי הוא G, אבל שימו לב שבסוף הסרטון אני מנגן את אקורד C.',
                    },
                    {
                        type: 'video',
                    ...
                    {
                        type: 'paragraph',
                        content: 'לפני שאתם מנסים בעצמכם אני רוצה שתשימו לב לכמה דגשים. דבר ראשון שימו לב שאתם מרימים מעט את שורש כף היד ויוצרים צורה מעט כדורית איתה. נסו לחשוב שאתם מחזיקים כדור טניס ביד, ואז תקבלו את הצורה הנכונה שלה.',
                    },
                    {
                        type: 'paragraph',
                        content: 'בנוסף לכך בדוגמה הזאת אני משתמש בפדל. עוד לא דיברנו על זה, אז כרגע אתם יכולים לנגן בלי פדל. אני רוצה שבתור התחלה תשחזרו את התנועה שאני עושה עם היד ועוד כמה רגעים נשלב גם עבודה עם פדל (אם אתם לא יודעים מה זה פדל, אז אגיד בקצרה שזה המתקן הזה שלוחצים עליו עם הרגל מתחת לפסנתר והוא עוזר לנו להחזיק את הצלילים מושהים, כלומר שימשיכו להשמיע סאונד גם אחרי שאנחנו עוזבים אותם).',
                    },
                    {
                        type: 'paragraph',
                        content: 'אז דיברנו קצת, הראתי לכם דוגמה ועכשיו תורכם לנגן. המשימה שלכם היא ללוות את האקורדים שכתובים למעלה בטכניקת השורשים כמו שהראתי בדוגמה. כמו שאמרתי, כרגע אין צורך להשתמש בפדל. תנגנו את התרגיל הזה 8 פעמים ותמשיכו הלאה. אם זה עדיין קשה תתאמנו על זה כמה זמן שאתם צריכים, אפילו כמה ימים. אל תוותרו עד שתצליחו.',
                    },
                ],
            },
            {
                ...
                elements: [
                    ...
                    {
                        type: 'paragraph',
                        content: 'הבנה ותרגול שימוש נכון בפדל זה עניין חשוב בשביל נגינה בפסנתר. זה יכול להיות מאתגר בהתחלה אבל אל תוותרו על זה. תתרגלו כל הזמן לנגן עם פדל. מעכשיו את כל התרגילים שננגן בפרקים הבאים, אני רוצה שתנגנו עם הפדל.',
                    },
                ],
            },
            {
                ...
                elements: [
                    ...
                    {
                        type: 'paragraph',
                        content: 'בתרגילים הבאים אתם תקבלו מהלך אקורדים, ואני רוצה שתנגנו אותו בטכניקת ליווי השורשים 8 פעמים. לאחר כל מהלך אקורדים תוכלו לראות סרטון שמדגים איך לנגן. אתם יכולים לנגן ביחד איתי כדי לוודא שאתם מנגנים נכון, ואז לנגן בעצמכם.',
                    },
                    {
                        type: 'chordilon',
                        content: {
                    ...
                    {
                        type: 'paragraph',
                        content: 'שליטה בטכניקת השורשים זה כל כך חשוב. אפילו להצליח לנגן איתה אקורדים מתוך סולם אחד. פיתוח כישורים של ניתוח אקורדים, מעקב אחרי הקצב של תרשים מוזיקלי, קואורדינציה בין נגינת אקורדים ועבודה עם פדל הפסנתר, את כל אלו אתם רוכשים בתרגילים של טכניקת השורשים.',
                    },
                    {
                        type: 'paragraph',
                        content: 'לכן אני מפציר בכם לא למהר בשלב הזה. תתאמנו על התרגילים האלו במשך כמה ימים. תנגנו את התרגילים בטכניקת השורשים, תקפידו לנגן בקצב הנכון, תקפידו להשתמש בפדל נכון ולנגן את האקורדים הנכונים. אחרי שתנגנו את התרגילים בביטחון, תמשיכו הלאה לפרקים הבאים ונמשיך להשיג עוד יעדים בדרך לנגינה בפסנתר.',
                    },
                ],
            },
            {

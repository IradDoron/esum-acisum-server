...
const modules: Module[] = [
	// ליווי שורשים ביד שמאל
	{
		...
		chapters: [
			// תיאור הטכניקה
			{
				title: 'מבוא לטכניקת השורשים',
				description: 'מהי טכניקת השורשים ואיך נשתמש בה',
				elements: [
					{
						type: 'subTitle',
						content: 'מהם שורשים?',
					...
					{
						type: 'subTitle',
						content: `מהי טכניקת ליווי שורשים?`,
					},
					{
						type: 'paragraph',
						content: `טכניקת ליווי שורשים, זאת טכניקת ליווי אקורדים בפסנתר שבה מנגנים רק את השורשים של האקורדים.`,
					},
					{
						type: 'paragraph',
						content: `כלומר כל עוד לאקורדים שונים יש את אותו השורש, אנחנו נלווה אותם באותו האופן בטכניקה הזאת.`,
					},
					{
						type: 'paragraph',
						content: `זאת טכניקת ליווי טובה למתחילים מכיוון שאין צורך להכיר את כל האקורדים, מספיק לדעת לזהות את השורש. אתם מהר מאוד תוכלו ללוות כל שיר בעזרת הטכניקה הזאת.`,
					},
					{
						type: 'paragraph',
						content:
							'אומר כבר עכשיו, הטכניקה הזאת היא הבסיס לטכניקות מורכבות יותר. שליטה בטכניקה הזאת תאפשר לכם להמשיך ללמוד עוד טכניקות רבות, אז תשקיעו את המאמץ הדרוש כדי להצליח להשתמש בה.',
					},
					{
						type: 'subTitle',
						content: 'אצבוע לטכניקת השורשים',
					},
					{
						type: 'paragraph',
						children: [],
						content:
							'בטכניקה הזו ננגן ביד שמאל עם אצבע מספר 5 את השורשים של האקורדים.',
					},
					{
						type: 'paragraph',
						children: [],
						content: 'אצבע מספר 5 זאת הזרת, כמו שאפשר לראות כאן:',
					},
					{
						type: 'image',
						children: [],
					...
					},
					{
						type: 'paragraph',
						content:
							'בכלי נגינה שונים יש שמות שונים לאצבעות. שיטת המספור שהראתי לכם בתמונה למעלה היא לנגינה בפסנתר.',
					},
					{
						type: 'subTitle',
						content: 'כמה פעמים ננגן את השורשים?',
					},
					{
						type: 'paragraph',
						content:
							'כל אקורד חדש, ננגן את השורש שלו פעם אחת. כלומר רק כשמתחלף אקורד אנחנו ננגן את השורש.',
					},
					{
						type: 'paragraph',
						content:
						...
						quizSections: [
							{
								...
								questions: [
									...
									{
										question: `מה נעשה אם אקורד אחד נמשך יותר מתיבה אחת?`,
			...
			{
				title: 'הדגמה בסיסית',
				description: 'נראה את טכניקת השורשים בפעולה',
				elements: [
					{
						type: 'subTitle',
						content: 'מהלך האקורדים',
					},
					{
						type: 'paragraph',
						content: `בפרק הזה נראה הדגמה של ליווי בטכניקת השורשים של האקורדים במהלך הבא:`,
					},
					{
						type: 'chordilon',
						content: {
					...
					{
						type: 'paragraph',
						content: `בדוגמה הזו, ובעוד הרבה דוגמאות במודול, אנחנו ננגן מהלכי אקורדים שבנויים בצורה כזאת שיהיה ניתן לחזור עליהם בלופ. כלומר כאשר מגיעים לאקורד האחרון, אפשר לחזור לנגן שוב מההתחלה.`,
					},
					{
						type: 'paragraph',
						content: `לכן בשביל לסיים תרגיל, או סרטון הדגמה, לרוב נסיים באקורד הראשון של מהלך האקורד, אחרי שביצענו כמה חזרות שרצינו של כל המהלך. אפשר לחזור פעם אחת, ואפשר פעמים רבות. `,
					},
					{
						type: 'paragraph',
						content: `למשל בדוגמה הזאת, האקורד הראשון הוא דו מז׳ור והאקורד האחרון הוא סול מז׳ור. בסרטון ההדגמה ניגנתי את המהלך רק פעם אחת, אז סיימתי באקורד דו מז׳ור, שכאמור זה האקורד הראשון.`,
					},
					{
						type: 'subTitle',
						content: 'סרטון הדגמה',
					...
					{
						type: 'paragraph',
						content: `תצפו בסרטון הבא שבו אני מנגן את מהלך האקורדים בטכניקת השורשים:`,
					},
					{
						type: 'video',
					...
					{
						type: 'paragraph',
						content: ` שימו לב שאתם מרימים מעט את שורש כף היד ויוצרים צורה מעט כדורית איתה. נסו לחשוב שאתם מחזיקים כדור טניס ביד, ואז תקבלו את הצורה הנכונה שלה.`,
					},
					{
						type: 'subTitle',
						content: `פדל הפסנתר`,
					},
					{
						type: 'paragraph',
						content:
							'בדוגמה הזאת אני משתמש בפדל. עוד לא דיברנו על זה, אז כרגע אתם יכולים לנגן בלי פדל. ',
					},
					{
						type: 'paragraph',
						content: `אני רוצה שבתור התחלה תשחזרו את התנועה שאני עושה עם היד ובהמשך נשלב גם עבודה עם פדל `,
					},
					{
						type: 'paragraph',
						content: `אם אתם לא יודעים מה זה פדל, אז אגיד בקצרה שזה המתקן הזה שלוחצים עליו עם הרגל מתחת לפסנתר והוא עוזר לנו להחזיק את הצלילים מושהים, כלומר שימשיכו להשמיע סאונד גם אחרי שאנחנו עוזבים אותם.`,
					},
					{
						type: 'subTitle',
						content: 'שיעורי בית',
					...
					{
						type: 'paragraph',
						content: 'אז דיברנו קצת, הראתי לכם דוגמה ועכשיו תורכם לנגן.',
					},
					{
						type: 'paragraph',
						content:
							'המשימה שלכם היא ללוות את האקורדים שכתובים למעלה בטכניקת השורשים כמו שהראתי בדוגמה. כמו שאמרתי, כרגע אין צורך להשתמש בפדל.',
					},
					{
						type: 'paragraph',
						content:
							'תנגנו את התרגיל הזה 8 פעמים ותמשיכו הלאה. אם זה עדיין קשה תתאמנו על זה כמה זמן שאתם צריכים, אפילו כמה ימים. אל תוותרו עד שתצליחו.',
					},
				],
			},
			// להוסיף פדל
			{
				title: 'להוסיף פדל',
				description: 'נכיר את חברו הטוב של הפסנתרן - פדל הפסנתר',
				elements: [
					{
						type: 'subTitle',
						content: 'מהו פדל הפסנתר?',
					},
					{
						type: 'paragraph',
						content: 'בואו נדבר על הפדל של הפסנתר.',
					},
					{
						type: 'paragraph',
					...
					{
						type: 'subTitle',
						content: 'למה צריך את הפדל?',
					},
					{
						type: 'paragraph',
						content: `הפדל מאפשר לנו לעבור בין אקורדים בלי ״הפסקות של שקט״ ביניהם. בצורה רציפה.`,
					},
					{
						type: 'paragraph',
					...
					},
					{
						type: 'paragraph',
						children: [],
						content: `כל עוד הפדל לחוץ, וניגנתם את האקורד הנוכחי, אתם יכולים להרים את היד בלי לאבד את הצלילים, הם ימשיכו לנגן בזכות כך שהפדל לחוץ.`,
					},
					{
						type: 'paragraph',
						content:
							'בזמן הזה אתם מזיזים את היד לקראת הצלילים של האקורד הבא, וברגע שאתם מנגנים את האקורד החדש, באותו רגע ממש, אתם מרימים את הפדל (כדי ״לנקות״ את הצלילים של האקורד הקודם), ואז אתם לוחצים עליו שוב כדי להשאיר את הצלילים של האקורד החדש.',
					},
					{
						type: 'paragraph',
						children: [],
			...
			// תרגול בסולם דו מז׳ור
			{
				...
				description: 'נתרגל ליווי אקורדים מתוך סולם דו מז׳ור',
				elements: [
					{
						type: 'subTitle',
						content: 'הקדמה',
					...
					{
						type: 'paragraph',
						content: `בפרק הזה נתרגל ליווי מהלכי אקורדים מתוך סולם דו מז׳ור. גם אם אתם לא זוכרים את כל האקורדים של הסולם הזה אתם עדיין יכולים להצליח את התרגילים.`,
					},
					{
						type: 'paragraph',
						content:
							'בטכניקת השורשים אנחנו מנגנים רק את השורשים של האקורדים, אז לא צריך לדעת את כל הצלילים של האקורדים. מספיק להכיר את צליל השורש.',
					},
					{
						type: 'subTitle',
						content: 'תרגילים',
					},
					{
						type: 'paragraph',
						content:
							'בתרגילים הבאים אתם תקבלו מהלך אקורדים, ואני רוצה שתנגנו אותו בטכניקת ליווי השורשים 8 פעמים.',
					},
					{
						type: 'chordilon',
						content: {
